          ...
          <main className="px-5 sm:px-8 py-16 flex-grow max-w-7xl mx-auto w-full">
            <div className="red-glass p-8 md:p-12 rounded-3xl border border-red-500/20 shadow-red">
              ...
              <section className="prose prose-lg max-w-none prose-headings:font-bold prose-headings:mt-8 prose-headings:mb-4 prose-p:my-4 prose-li:my-1 prose-li:ml-4">
                <h1 className="text-3xl mt-0">Privacy Policy</h1>
                <p className="text-sm opacity-75">Last updated: May 23, 2025</p>
                <p className="mt-6">
                ...
                <h2 className="text-2xl mt-10">Collecting and Using Your Personal Data</h2>
                ...
                <h2 className="text-2xl mt-10">Children&apos;s Privacy</h2>
                <p>
                ...
                <h2 className="text-2xl mt-10">Changes to this Privacy Policy</h2>
                <p>
