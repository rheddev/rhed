    ...
    <SidebarProvider>
      <div className="bg-wood min-h-screen w-screen overflow-x-hidden flex flex-col">
        ...
        <div className="relative z-10 flex flex-col min-h-screen w-full">
          ...
          <main className="px-5 sm:px-8 py-16 flex-grow max-w-7xl mx-auto w-full">
            <div className="red-glass p-8 md:p-12 rounded-3xl border border-red-500/20 shadow-red">
              <h1 className="text-4xl sm:text-5xl font-bold mb-12 text-glow text-center">
                Terms of Service
              </h1>

              <section className="prose prose-lg max-w-none prose-headings:font-bold prose-headings:mt-8 prose-headings:mb-4 prose-p:my-4 prose-li:my-1 prose-li:ml-4">
                <h1 className="text-3xl mt-0">Terms and Conditions</h1>
                <p className="text-sm opacity-75">Last updated: May 24, 2025</p>
                <p className="mt-6">
                  Please read these terms and conditions carefully before using
                  Our Service.
                </p>
                <h2 className="text-2xl mt-10">Interpretation and Definitions</h2>
                ...
                <ul className="list-disc pl-5 space-y-3">
                  ...
                  <li>
                    <p className="mb-0">
                      ...
                      Company&quot;, &quot;We&quot;, &quot;Us&quot; or
                      &quot;Our&quot; in this Agreement) refers to Rhed.
                    </p>
                  </li>
                  <li>
                    <p className="mb-0">
                  ...
                  <li>
                    <p className="mb-0">
                      <strong>Website</strong> refers to Rhed, accessible from{" "}
                      <Link
                ...
                <h2 className="text-2xl mt-10">Acknowledgment</h2>
                <p>
                ...
                <h2 className="text-2xl mt-10">Links to Other Websites</h2>
                <p>
                ...
                <h2 className="text-2xl mt-10">Termination</h2>
                <p>
                ...
                <h2 className="text-2xl mt-10">Limitation of Liability</h2>
                <p>
                ...
                <h2 className="text-2xl mt-10">&quot;AS IS&quot; and &quot;AS AVAILABLE&quot; Disclaimer</h2>
                <p>
                ...
                <h2 className="text-2xl mt-10">Governing Law</h2>
                <p>
                ...
                <h2 className="text-2xl mt-10">Disputes Resolution</h2>
                <p>
                ...
                <h2 className="text-2xl mt-10">For European Union (EU) Users</h2>
                <p>
                  If You are a European Union consumer, you will benefit from any
                  mandatory provisions of the law of the country in which You are
                  resident.
                </p>
                <h2 className="text-2xl mt-10">United States Legal Compliance</h2>
                <p>
                ...
                <h2 className="text-2xl mt-10">Severability and Waiver</h2>
                ...
                <h2 className="text-2xl mt-10">Translation Interpretation</h2>
                <p>
                ...
                <h2 className="text-2xl mt-10">Changes to These Terms and Conditions</h2>
                <p>
                ...
                <ul className="list-disc pl-5">
                  <li>By email: <a href="mailto:rheddev@gmail.com" className="underline">rheddev@gmail.com</a></li>
                </ul>
              </section>
            </div>
          </main>
