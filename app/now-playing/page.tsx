...
const SpotifyLogo = () => {
  return (
    <svg className="w-12 h-12 m-4 filter drop-shadow-glow-green" viewBox="0 0 24 24" fill="currentColor">
          ...
          <div className="text-white px-3 py-2 flex-1 overflow-hidden flex flex-col">
            <div className="flex items-center gap-2 w-full">
              ...
              <div className="overflow-hidden flex-1 w-full">
                <div className="overflow-hidden w-full">
                  <p
                    className={`font-bold whitespace-nowrap w-full text-glow chat-text truncate ${songTitle.length > 20 ? 'animate-marquee' : ''
                      }`}
                    style={{
                      fontSize: "300%"
                    }}
                ...
                <div className="overflow-hidden mt-1 w-full">
                  <p
                    className={`text-gray-300 whitespace-nowrap w-full truncate ${artistName.length > 25 ? 'animate-marquee-slow' : ''
                      }`}
                    style={{
                      fontSize: "150%"
                    }}
